...
# 1) FORSE TOGLIERE 50 COMPLESSI DAL SET SULLA BASE DEL QUALE CALCOLARE I POTENZIALI (CHIEDI A EDO)
# 2) IMPLEMENTARE EQUAZIONE PER SPARSE DATA E VEDERE SE I DUE POTENZIALI (SPARSE VS NON SPARSE) CORRELANO SUFFICIENTEMENTE
# 3) CERCARE ANCHE SE ESISTANO METODI MIGLIORI PER MIGLIORARE AGREEMENT OLTRE ALLA CORRELAZIONE DI PEARSON
### Required libraries
library(bio3d)
library(dplyr)
library(future)
...
#pdb_path <- "/Users/lorenzosisti/Downloads/potenziali_statistici_test_training/training_dir/7dwt.pdb"
