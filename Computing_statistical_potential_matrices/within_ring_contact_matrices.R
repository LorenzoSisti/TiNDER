...
results_dir_intra <- "/path/to/the/directory/where/you/want/to/save/the/matrices/and/residue/count/" 
dir.create(results_dir_intra, recursive = TRUE, showWarnings = FALSE)
...
# Save results 
datasets <- list(
  contact_matrices_rings = contact_matrices_rings_sum,
...
### Load saved data ###
contact_matrix <- readRDS(file.path(results_dir_intra, "contact_matrices_rings.rds"))
